...
public class SellsRegisterGUI extends JPanel {
    ...
    public SellsRegisterGUI() {
        ...
        searchButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                // TODO ignore case
                SellsRegisterGUI.this.searchResultsListModel.removeAllElements();
                ...
                if (searchResult.isEmpty()) {
                    ...
                    for (Album album : searchResult) {
                        SellsRegisterGUI.this.searchResultsListModel.addElement(album);
                    }
                }
            }
        });
